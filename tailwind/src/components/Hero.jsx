  ...
  return (
    <div className=' text-white text-2xl md:text-3xl lg:text-4xl xl:text-5xl p-5 md:p-6 lg:p-7 '>
        ...
        <div className='flex justify-center space-x-5 text-lg '>
          <a data-aos="zoom-in-left" href="#" className='border px-2 py-1 bg-gradient-to-r from-orange-500 to-orange-700 rounded-md'>start now</a>
          <a  data-aos="zoom-in-right" href="#" className='border px-2 py-1 rounded-md'>coding sheet</a>
        
        </div>
        <div className='flex flex-wrap justify-center mt-7 sm:space-x-10 gap-5'>
          <img data-aos="zoom-in-left" className='w-60 h-60 rounded-md' src={img002} alt="" />
          <img data-aos="zoom-in-right" className='w-60 h-60 rounded-md' src={img003} alt="" />
        </div>
